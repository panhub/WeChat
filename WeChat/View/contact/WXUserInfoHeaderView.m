...
- (void)setUser:(WXUser *)user {
    ...
    /// 备注
    self.noteNameLabel.text = [NSString replacingBlankCharacter:user.name];
    ...
    self.genderView.image = [UIImage imageNamed:(user.gender == MNGenderMale ? @"wx_contacts_gender_male" : @"wx_contacts_gender_female")];
