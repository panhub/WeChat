...
- (instancetype)initWithMoment:(WXMoment *)moment {
    if (self = [super initWithFrame:CGRectMake(0.f, 0.f, MN_SCREEN_WIDTH, 0.f)]) {
...
- (void)createView {
    ...
    UIView *bottomBar = [[UIView alloc] initWithFrame:CGRectMake(0.f, contentLabel.bottom_mn + 7.f, self.width_mn, 40.f + MN_TAB_SAFE_HEIGHT)];
    ...
    UILabel *leftBarLabel = [UILabel labelWithFrame:CGRectMake(contentLabel.left_mn + 2.f, MEAN(bottomBar.height_mn - font.lineHeight - MN_TAB_SAFE_HEIGHT), 130.f, font.lineHeight)
