...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier size:(CGSize)size {
    if (self = [super initWithReuseIdentifier:reuseIdentifier size:size]) {
        ...
        UIImageView *headView = [UIImageView imageViewWithFrame:CGRectMake(arrowView.left_mn - (self.contentView.height_mn - 20.f), 0.f, self.contentView.height_mn - 21.f, self.contentView.height_mn - 21.f) image:nil];
        headView.centerY_mn = self.contentView.height_mn/2.f;
        headView.layer.cornerRadius = 3.f;
