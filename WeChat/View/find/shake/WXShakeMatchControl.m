...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        UILabel *titleLabel = [UILabel labelWithFrame:CGRectZero text:nil textAlignment:NSTextAlignmentCenter textColor:UIColorWithSingleRGB(178.f) font:UIFontRegular(12.f)];
