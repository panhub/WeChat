...
#define WXMusicPlayerDisableColor  R_G_B(145.f, 154.f, 165.f)
...
- (void)setStyle:(WXMusicPlayStyle)style {
    _style = style;
    self.imageView.tintColor = self.isEnabled ? (style == WXMusicPlayStyleDark ? WXMusicPlayerWhiteColor : WXMusicPlayerDarkColor) : WXMusicPlayerDisableColor;
}
