...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        /**返回*/
        UIButton *backButton = [UIButton buttonWithFrame:CGRectMake(10.f, MEAN(self.height_mn - 30.f - UIStatusBarHeight()) + UIStatusBarHeight(), 30.f, 30.f)
        ...
        /**标题*/
        UILabel *titleLabel = [UILabel labelWithFrame:CGRectMake(backButton.right_mn + 7.f, UIStatusBarHeight(), lockButton.left_mn - backButton.right_mn - 14.f, self.height_mn - UIStatusBarHeight())
                                                 text:@""
...
- (void)setTitle:(NSString *)title {
    NSStringReplaceBlankString(&title);
    _title = title.copy;
