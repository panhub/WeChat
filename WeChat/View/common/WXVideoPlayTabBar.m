...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        /**播放暂停*/
        UIButton *playButton = [UIButton buttonWithFrame:CGRectMake(10.f, MEAN(self.height_mn - MN_TAB_SAFE_HEIGHT - 35.f), 35.f, 35.f)
                                                   image:nil
                                                 title:nil
                                            titleColor:nil
                                                  titleFont:nil];
        ...
        /// 当前时长
        UILabel *currentLabel = [UILabel labelWithFrame:CGRectMake(playButton.right_mn + 7.f, 0.f, 40.f, 13.f) text:@"00:00" alignment:NSTextAlignmentRight textColor:[UIColor whiteColor] font:[UIFont systemFontOfSize:13.f]];
        ...
        /// 总时长
        UILabel *durationLabel = [UILabel labelWithFrame:currentLabel.frame text:@"00:00" alignment:NSTextAlignmentLeft textColor:currentLabel.textColor font:currentLabel.font];
...
- (void)setTimeInterval:(NSTimeInterval)timeInterval {
    ...
    self.currentLabel.text = [NSDate timeStringWithInterval:@(timeInterval)];
}

- (void)setDuration:(NSTimeInterval)duration {
    _duration = duration;
    self.durationLabel.text = [NSDate timeStringWithInterval:@(duration)];
}
