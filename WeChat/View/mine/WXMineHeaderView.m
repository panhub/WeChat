...
- (void)createView {
    ...
    rightButton.frame = CGRectMake(self.contentView.width_mn - 37.f, STATUS_BAR_HEIGHT + MEAN(NAV_BAR_HEIGHT - 22.f), 22.f, 22.f);
    ...
    UIImageView *headView = [UIImageView imageViewWithFrame:CGRectMake(25.f, TOP_BAR_HEIGHT + 30.f, 65.f, 65.f)
                                                      image:nil];
...
- (void)updateUserInfo {
    ...
    self.idLabel.text = NSStringWithFormat(@"微信号: %@", [NSString replacingBlankCharacter:user.wechatId]);
}
