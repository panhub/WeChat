...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        backgroundView.backgroundColor = R_G_B(60.f, 179.f, 113.f);
        ...
        [titles enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            UILabel *label = [UILabel labelWithFrame:CGRectMake(0.f, button.bottom_mn + 20.f, backgroundView.width_mn/2.f, 17.f) text:obj textAlignment:NSTextAlignmentCenter textColor:[UIColor whiteColor] font:[UIFont systemFontOfSize:17.f]];
            ...
            UILabel *moneyLabel = [UILabel labelWithFrame:CGRectMake(0.f, label.bottom_mn + 7.f, backgroundView.width_mn/2.f, 15.f) text:@"" textAlignment:NSTextAlignmentCenter textColor:[UIColor.whiteColor colorWithAlphaComponent:.51f] font:SansFontMedium(15.f)];
