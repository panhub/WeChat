...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        UILabel *helpLabel = [UILabel labelWithFrame:CGRectMake(0.f, applyButton.bottom_mn + 33.f, 0.f, 14.f) text:@"常见问题" textAlignment:NSTextAlignmentCenter textColor:UIColorWithRGB(115.f, 135.f, 179.f) font:UIFontLight(13.f)];
        [helpLabel sizeToFit];
