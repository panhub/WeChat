...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier size:(CGSize)size {
    if (self = [super initWithReuseIdentifier:reuseIdentifier size:size]) {
        ...
        UILabel *valueLabel = [UILabel labelWithFrame:CGRectMake(0.f, 0.f, 0.f, 22.f) text:nil textAlignment:NSTextAlignmentCenter textColor:R_G_B(249.f, 156.f, 59.f) font:[UIFont systemFontOfSize:12.f]];
        valueLabel.centerY_mn = self.imgView.centerY_mn;
        valueLabel.backgroundColor = R_G_B(253.f, 236.f, 217.f);
