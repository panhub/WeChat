...
- (void)createView {
    ...
    UILabel *hintLabel = [UILabel labelWithFrame:CGRectMake(15.f, 13.f, contentView.width_mn - 30.f, 30.f) text:@"请输入支付密码" textAlignment:NSTextAlignmentCenter textColor:UIColorWithAlpha([UIColor darkTextColor], .9f) font:[UIFont systemFontOfSize:18.f]];
    [contentView addSubview:hintLabel];
    
    UIButton *closeButton = [UIButton buttonWithFrame:CGRectMake(13.f, hintLabel.top_mn, hintLabel.height_mn, hintLabel.height_mn)
    ...
    UILabel *titleLabel = [UILabel labelWithFrame:CGRectMake(hintLabel.left_mn, hintLabel.bottom_mn + 20.f, hintLabel.width_mn, 30.f) text:@"" textAlignment:NSTextAlignmentCenter textColor:UIColorWithAlpha([UIColor darkTextColor], .9f) font:[UIFont systemFontOfSize:17.f]];
    ...
    MNPasswordView *passwordView = [[MNPasswordView alloc] initWithFrame:CGRectMake(MEAN(contentView.width_mn - 48.f*6.f), payLabel.bottom_mn + 35.f, 48.f*6.f, 48.f) capacity:6];
