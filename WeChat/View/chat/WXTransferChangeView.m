...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        UIImageView *top_line = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"moment_more_line"]];
        ...
        UIImageView *bottom_line = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"moment_more_line"]];
...
- (void)setFrame:(CGRect)frame {
    frame.size.width = MN_SCREEN_WIDTH;
