...
- (void)createView {
    ...
    contentView.backgroundColor = R_G_B(224.f, 84.f, 73.f);
    ...
    */
    ...
    /// 文字/金额
    UILabel *textLabel = [UILabel labelWithFrame:CGRectMake(15.f, headView.bottom_mn + 20.f, contentView.width_mn - 30.f, 24.f) text:nil textAlignment:NSTextAlignmentCenter textColor:fromLabel.textColor font:[UIFont systemFontOfSize:24.f]];
    ...
    UILabel *detailLabel = [UILabel labelWithFrame:CGRectMake(0.f, contentView.height_mn - 55.f, contentView.width_mn, 50.f) text:nil textAlignment:NSTextAlignmentCenter textColor:nil font:nil];
