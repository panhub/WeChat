...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier size:(CGSize)size {
    if (self = [super initWithReuseIdentifier:reuseIdentifier size:size]) {
        ...
        UILabel *moneyLabel = [UILabel labelWithFrame:CGRectMake(0.f, self.titleLabel.top_mn, 0.f, self.titleLabel.height_mn) text:nil textAlignment:NSTextAlignmentRight textColor:self.titleLabel.textColor font:self.titleLabel.font];
