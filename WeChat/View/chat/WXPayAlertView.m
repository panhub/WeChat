...
- (void)createView {
    ...
    UILabel *titleLabel = [UILabel labelWithFrame:CGRectMake(15.f, closeButton.bottom_mn + 18.f, contentView.width_mn - 30.f, 20.f) text:@"" alignment:NSTextAlignmentCenter textColor:UIColorWithAlpha([UIColor darkTextColor], .9f) font:[UIFont systemFontOfSize:17.f]];
