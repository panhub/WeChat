...
- (void)createView {
    ...
    /// 背景图
    self.imageView.image = [UIImage imageWithColor:R_G_B(243.f, 85.f, 67.f)];
    ...
    /// 头像
    UIImageView *headView = [UIImageView imageViewWithFrame:CGRectMake(0.f, TOP_BAR_HEIGHT + 30.f, 25.f, 25.f) image:nil];
    headView.layer.cornerRadius = 4.f;
    headView.clipsToBounds = YES;
    [self.contentView addSubview:headView];
    self.headView = headView;
    
    UILabel *fromLabel = [UILabel labelWithFrame:CGRectMake(0.f, 0.f, 0.f, headView.height_mn) text:nil textColor:R_G_B(254.f, 225.f, 177.f) font:[UIFont systemFontOfSizes:headView.height_mn - 6.f weights:.5f]];
    fromLabel.centerY_mn = headView.centerY_mn;
    fromLabel.textAlignment = NSTextAlignmentCenter;
    [self.contentView addSubview:fromLabel];
    self.fromLabel = fromLabel;
    
    UILabel *textLabel = [UILabel labelWithFrame:CGRectMake(15.f, headView.bottom_mn + 10.f, self.contentView.width_mn - 30.f, 14.f) text:nil textAlignment:NSTextAlignmentCenter textColor:fromLabel.textColor font:@(14.f)];
    ...
    UILabel *detailLabel = [UILabel labelWithFrame:CGRectMake(0.f, moneyLabel.bottom_mn, self.contentView.width_mn, 25.f) text:nil textAlignment:NSTextAlignmentCenter textColor:nil font:nil];
    ...
    string.color = R_G_B(255.f, 226.f, 177.f);
    string.font = font;
...
- (void)setRedpacket:(WXRedpacket *)redpacket {
    ...
    WXUser *user = [[MNChatHelper helper] userForUid:redpacket.from_uid];
