...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        UILabel *unitLabel = [UILabel labelWithFrame:CGRectMake(self.width_mn - 28.f - titleLabel.left_mn, titleLabel.top_mn, 28.f, titleLabel.height_mn) text:@"元" alignment:NSTextAlignmentRight textColor:titleLabel.textColor font:titleLabel.font];
