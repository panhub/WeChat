...
/// 微信名片消息分割线高度
#define WXCardMsgSeparatorHeight    (IS_LOW_SCALE ? .5f : .3f)
/// 微信名片消息头像与文字间距
...
/// 微信红包领取描述高亮颜色
#define WXRedpacketMsgDescTextHighlightColor    R_G_B(250.f, 157.f, 59.f)
/// 微信转账消息标题文字颜色
...
/// 微信转账领取描述高亮颜色
#define WXTransferMsgDescTextHighlightColor    R_G_B(250.f, 157.f, 59.f)
/// 微信语音消息时长文字颜色
