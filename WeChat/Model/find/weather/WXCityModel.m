...
+ (instancetype)modelWithDic:(NSDictionary *)dictionary {
    NSString *district = [MNJSONSerialization stringValueWithJSON:dictionary forKey:@"district"];
...
+ (instancetype)modelWithDic:(NSDictionary *)dictionary {
    NSString *city = [MNJSONSerialization stringValueWithJSON:dictionary forKey:@"city"];
    if (city.length <= 0) return nil;
    NSArray <NSDictionary *>*districts = [MNJSONSerialization arrayValueWithJSON:dictionary forKey:@"district"];
...
+ (instancetype)modelWithDic:(NSDictionary *)dictionary {
    NSString *province = [MNJSONSerialization stringValueWithJSON:dictionary forKey:@"province"];
    if (province.length <= 0) return nil;
    NSArray <NSDictionary *>*citys = [MNJSONSerialization arrayValueWithJSON:dictionary forKey:@"city"];
