...
+ (instancetype)fileWithImage:(UIImage *)image session:(NSString *)session {
    ...
    NSString *filePath = [MNChatHelper.helper.directoryPath stringByAppendingFormat:@"/%@/%@.%@", session, MNFileHandle.fileName, (image.isAnimatedImage ? @"gif":@"png")];
...
+ (instancetype)fileWithDictionary:(NSDictionary *)dictionary session:(NSString *)session {
    ...
    NSString *filePath = [MNChatHelper.helper.directoryPath stringByAppendingFormat:@"/%@/%@", session, identifier];
...
+ (instancetype)fileWithAudio:(NSString *)audioPath session:(NSString *)session {
    ...
    NSString *identifier = MNFileHandle.fileName;
    NSString *filePath = [MNChatHelper.helper.directoryPath stringByAppendingFormat:@"/%@/%@.wav", session, identifier];
...
+ (instancetype)fileWithVideo:(NSString *)videoPath session:(NSString *)session {
    ...
    NSString *identifier = MNFileHandle.fileName;
    NSString *filePath = [MNChatHelper.helper.directoryPath stringByAppendingFormat:@"/%@/%@.mp4", session, identifier];
...
- (NSString *)filePath {
    if (!_filePath && _session.length && _identifier.length && _type != WXFileTypeUnknown) {
        _filePath = [MNChatHelper.helper.directoryPath stringByAppendingFormat:@"/%@/%@", _session, _identifier];
