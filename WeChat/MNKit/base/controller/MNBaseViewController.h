...
@interface MNBaseViewController : UIViewController<MNEmptyViewDelegate, MNDragViewDelegate>
/**
 标记视图是否在显示状态
 */
...
/**
 已经添加空数据视图
 @param superview 空数据视图的父视图
 */
- (void)didMoveEmptyViewToSuperview:(__kindof UIView *)superview;
