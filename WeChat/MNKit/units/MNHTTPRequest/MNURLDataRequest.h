...
/**
 数据缓存策略
 - MNURLCachePolicyNever: 不缓存
 - MNURLCachePolicyDontLoad: 加载前查询缓存
 - MNURLCachePolicyElseLoad: 加载失败查询缓存
 */
typedef NS_ENUM(NSInteger, MNURLCachePolicy) {
    MNURLCachePolicyNever = 0,
    MNURLCachePolicyDontLoad,
    MNURLCachePolicyElseLoad
};
...
/**缓存策略*/
@property (nonatomic) MNURLCachePolicy cachePolicy;
/**定制缓存的key*/
