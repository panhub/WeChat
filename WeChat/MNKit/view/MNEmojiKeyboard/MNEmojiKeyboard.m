...
+ (MNEmojiKeyboard *)keyboard {
    return [[MNEmojiKeyboard alloc] initWithKeyboardStyle:MNEmojiKeyboardStyleLight height:(MN_TAB_SAFE_HEIGHT + 260.f)];
}

- (instancetype)init {
    return [self initWithKeyboardStyle:MNEmojiKeyboardStyleLight height:(MN_TAB_SAFE_HEIGHT + 260.f)];
}
