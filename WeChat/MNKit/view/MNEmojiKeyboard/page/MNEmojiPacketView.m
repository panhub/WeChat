...
- (instancetype)initWithConfiguration:(MNEmojiKeyboardConfiguration *)configuration {
    ...
    frame.size.height = configuration.style == MNEmojiKeyboardStyleLight ? 50.f : MN_TAB_SAFE_HEIGHT + 40.f;
    if (self = [super initWithFrame:frame]) {
        ...
        self.hidden = !configuration.isAllowsUseEmojiPackets;
        ...
        separator.hidden = configuration.style == MNEmojiKeyboardStyleLight;
        ...
        if (configuration.style == MNEmojiKeyboardStyleLight) {
            ...
            returnButton.size_mn = CGSizeMake(55.f, self.height_mn - MN_TAB_SAFE_HEIGHT - separator.bottom_mn);
        }
