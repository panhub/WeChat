...
FOUNDATION_EXTERN NSString * const MNEmojiUpdateKey;
FOUNDATION_EXTERN NSNotificationName const MNEmojiUpdateNotificationName;
...
/**
 唯一实例化方式
 */
@property (nonatomic, class, readonly) MNEmojiManager *defaultManager;
...
/**
 ...
 @return 表情对象
 */
- (MNEmoji *_Nullable)emojiForDesc:(NSString *)desc;
...
/**
 ...
 @return 表情对象
 */
- (MNEmoji *_Nullable)emojiForDescUseCache:(NSString *)desc;
...
/**
 ...
 @return 是否添加成功
 */
- (BOOL)insertEmojiToFavorites:(UIImage *)emojiImage desc:(NSString *_Nullable)desc;
...
/**
 ...
 @return 表情附件
 */
+ (NSArray<MNEmojiAttachment *> *_Nullable)matchingEmojiForString:(NSString *)string;
