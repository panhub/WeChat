...
NSString * const MNEmojiUpdateKey = @"com.mn.emoji.update.key";
NSNotificationName const MNEmojiUpdateNotificationName = @"com.mn.emoji.update.notification.name";
...
- (BOOL)insertEmojiToFavorites:(UIImage *)emojiImage desc:(NSString *)desc {
    ...
    [NSNotificationCenter.defaultCenter postNotificationName:MNEmojiUpdateNotificationName object:self userInfo:@{MNEmojiUpdateKey:packet}];
    return YES;
}
