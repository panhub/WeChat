...
- (void)initialized {
    ...
    _scanAreaX = (self.width_mn - _scanSize.width)/2.f;
    _scanAreaY = (self.height_mn - _scanSize.height)/2.f;
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextAddRect(context, CGRectMake(_scanAreaX - _borderWidth/2.f, _scanAreaY - _borderWidth/2.f, _scanSize.width + _borderWidth, _scanSize.height + _borderWidth));
