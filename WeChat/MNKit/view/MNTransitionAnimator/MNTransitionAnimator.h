...
typedef NS_ENUM(NSInteger, MNControllerTransitionType) {
    ...
    MNControllerTransitionTypePushModal,            /**进栈的形式下模仿模态弹出*/
    MNControllerTransitionTypeDefaultModal,        /**默认的Model转场 modalPresentationStyle = UIModalPresentationFullScreen*/
    MNControllerTransitionTypeSheetModal,          /**ActionSheet转场样式*/
    MNControllerTransitionTypeAlertModal,           /**AlertView转场样式*/
    MNControllerTransitionTypeMenuModal,          /**菜单转场*/
    MNControllerTransitionType3DMenuModal,      /**3D菜单转场*/
    MNControllerTransitionTypeMusicModal          /**音乐播放定制转场*/
};
...
/**
 模态转场手势添加视图
 */
@property (nonatomic) UIView *modalTouchView;
/**
 转场时捕获快照
 @return 视图快照
 */
