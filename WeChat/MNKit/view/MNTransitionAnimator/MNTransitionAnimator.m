...
- (void)initializeWithContext:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    */
    ...
    /**标记 tabBar*/
    if (!_fromController.tabBarController || _tabBarTransitionType == MNTabBarTransitionTypeNone) return;
    if (_transitionOperation && _tabView && (_tabView.hidden || _tabView.alpha == 0.f)) return;
