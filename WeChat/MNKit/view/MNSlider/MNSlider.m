...
- (void)createView {
    ...
    /**轨迹*/
    UIView *trackView = [[UIView alloc] initWithFrame:CGRectMake(MEAN(contentView.height_mn), MEAN(contentView.height_mn - MNSliderTrackNormalHeight), contentView.width_mn - contentView.height_mn, MNSliderTrackNormalHeight)];
    ...
    trackView.layer.cornerRadius = MEAN(trackView.height_mn);
    ...
    progressView.layer.cornerRadius = MEAN(progressView.height_mn);
    ...
    thumbView.layer.cornerRadius = MEAN(thumbView.width_mn);
    ...
    touchView.layer.cornerRadius = MEAN(touchView.height_mn);
...
- (void)setProgress:(float)progress {
    ...
    _thumbView.right_mn = _progressView.right_mn + MEAN(_thumbView.width_mn);
}
...
- (void)setTrackHeight:(CGFloat)trackHeight {
    ...
    _trackView.top_mn = MEAN(_contentView.height_mn - trackHeight);
