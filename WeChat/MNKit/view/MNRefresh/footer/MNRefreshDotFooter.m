...
- (UILabel *)textLabel {
    if (!_textLabel) {
        UILabel *textLabel = [UILabel labelWithFrame:self.contentView.bounds text:@"~人家是有底线的~" textAlignment:NSTextAlignmentCenter textColor:UIColorWithSingleRGB(220.f) font:UIFontRegular(15.f)];
