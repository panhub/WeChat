...
- (void)createView {
    ...
    for (NSInteger idx = 0; idx < _capacity; idx++) {
        ...
        mask.frame = CGRectMake((label.width_mn - MNPasswordMaskFont)/2.f, (label.height_mn - MNPasswordMaskFont)/2.f, MNPasswordMaskFont, MNPasswordMaskFont);
        mask.cornerRadius = mask.height_mn/2.f;
