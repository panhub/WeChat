...
- (void)createView {
    ...
    leftView.centerY_mn = self.height_mn/2.f;
    ...
    self.placeholder = @"";
    CGSize size = [NSString stringSize:placeholder font:self.placeholderFont];
    ...
    CGFloat x = (self.width_mn - contentView.width_mn + self.leftInset.left)/2.f;
