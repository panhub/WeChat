...
#define MNDebugViewShowWH        (UIScreenMin()/4.f*2.8f)
...
- (MNFPSLabel *)fpsLabel {
    if (!_fpsLabel) {
        ...
        fpsLabel.bottom_mn = UIStatusBarHeight() + UINavBarHeight() - 2.f;
...
- (MNStreamView *)streamView {
    if (!_streamView) {
        ...
        streamView.bottom_mn = UIStatusBarHeight() + UINavBarHeight() - 2.f;
