...
/**
 ...
 - MNLoadDialogStyleComplete: 完成
 - MNLoadDialogStylePay: 微信支付样式
 - MNLoadDialogStyleWechatLoading: 微信加载弹窗
 - MNLoadDialogStyleWechatComplete: 微信完成弹窗
 - MNLoadDialogStyleWechatError: 微信错误弹窗
 */
typedef NS_ENUM(NSInteger, MNLoadDialogStyle) {
    ...
    MNLoadDialogStyleComplete,
    MNLoadDialogStylePay,
    MNLoadDialogStyleWechatLoading,
    MNLoadDialogStyleWechatComplete,
    MNLoadDialogStyleWechatError
};
