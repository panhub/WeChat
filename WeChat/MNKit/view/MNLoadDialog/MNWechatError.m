...
#import "MNWechatError.h"

#define MNWechatErrorMinWH     100.f

@interface MNWechatError ()
@property (nonatomic, strong) UIImageView *imageView;
@end

@implementation MNWechatError
- (void)createView {
    [super createView];
    ...
    imageView.image = [MNBundle imageForResource:@"wechat_error"];
