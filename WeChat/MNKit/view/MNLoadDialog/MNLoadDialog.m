...
- (NSDictionary *)attributes {
    if (!_attributes) {
        ...
        _attributes = @{NSFontAttributeName:[UIFont systemFontOfSize:MNLoadDialogFontSize], NSForegroundColorAttributeName:MNLoadDialogContentColor(), NSParagraphStyleAttributeName:paragraphStyle};
    }
    return _attributes;
}
