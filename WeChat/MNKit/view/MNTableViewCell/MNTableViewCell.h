...
/**
 分割线样式
 - MNTableViewCellSeparatorStyleNone: 不显示分割线
 - MNTableViewCellSeparatorStyleSingleLine: 底部分割线
 */
typedef NS_ENUM(NSInteger, MNTableViewCellSeparatorStyle) {
    MNTableViewCellSeparatorStyleNone,
    MNTableViewCellSeparatorStyleSingleLine
};
...
/**
 是否显示分割线
 */
@property (nonatomic) MNTableViewCellSeparatorStyle separatorStyle;
/**
 交互代理
 */
