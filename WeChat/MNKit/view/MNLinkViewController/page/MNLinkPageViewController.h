...
#import "MNLinkPageViewControllerProtocol.h"

@interface MNLinkPageViewController : MNLinkController

/**数据源代理*/
@property (nonatomic, weak)  id<MNLinkPageControllerDataSource> dataSource;
/**交互代理*/
@property (nonatomic, weak)  id<MNLinkPageControllerDelegate> delegate;
/**开启/禁用交互滑动*/
