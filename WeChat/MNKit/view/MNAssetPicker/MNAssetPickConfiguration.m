...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.allowsMultiplePickingGif = YES;
        self.allowsPickingVideo = NO;
        self.allowsMultiplePickingVideo = YES;
        self.allowsPickingPhoto = YES;
        self.allowsMultiplePickingPhoto = YES;
        self.allowsPickingLivePhoto = NO;
        self.allowsMultiplePickingLivePhoto = YES;
        ...
        self.allowsOptimizeExporting = NO;
