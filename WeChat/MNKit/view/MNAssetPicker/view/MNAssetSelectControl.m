...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        UILabel *textLabel = [UILabel labelWithFrame:self.bounds text:nil textAlignment:NSTextAlignmentCenter textColor:UIColorWithSingleRGB(251.f) font:[UIFont systemFontOfSize:12.f]];
