...
- (void)didMoveToSuperview {
    ...
    if (self.superview && !self.configuration) {
        self.delegate = (id<MNAssetCellDelegate>)(self.viewController);
        if ([self.delegate respondsToSelector:@selector(assetCellShouldUsingConfiguration)]) {
            self.configuration = [self.delegate assetCellShouldUsingConfiguration];
