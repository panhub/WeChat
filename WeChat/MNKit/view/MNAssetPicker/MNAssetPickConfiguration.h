...
/**
 是否允许多选图片 <default YES>
 */
@property (nonatomic, getter=isAllowsMultiplePickingPhoto) BOOL allowsMultiplePickingPhoto;
/**
 是否允许挑选视频 <default YES>
 */
@property (nonatomic, getter=isAllowsPickingVideo) BOOL allowsPickingVideo;
/**
 是否允许多选视频 <default YES>
 */
@property (nonatomic, getter=isAllowsMultiplePickingVideo) BOOL allowsMultiplePickingVideo;
/**
 是否允许挑选GIF
 */
@property (nonatomic, getter=isAllowsPickingGif) BOOL allowsPickingGif;
/**
 是否允许多选GIF <default YES>
 */
@property (nonatomic, getter=isAllowsMultiplePickingGif) BOOL allowsMultiplePickingGif;
/**
 是否允许挑选LivePhoto
 */
@property (nonatomic, getter=isAllowsPickingLivePhoto) BOOL allowsPickingLivePhoto;
/**
 是否允许多选LivePhoto <default YES>
 */
@property (nonatomic, getter=isAllowsMultiplePickingLivePhoto) BOOL allowsMultiplePickingLivePhoto;
/**
 是否允许输出HEIF格式图片 API_AVAILABLE(ios(10.0))
 */
...
/**
 优化导出的图片<接近于微信朋友圈质量, 详查"UIImage+MNResizing.h" -> compressImage>
 */
@property (nonatomic, getter=isAllowsOptimizeExporting) BOOL allowsOptimizeExporting;
/**
...
/**
 视频导出路径<视频裁剪选项>
 */
@property (nonatomic, copy, nullable) NSURL *exportURL;
/**
 预览图大小<太大会影响性能>
 */
...
/**
 是否允许显示选择原图<使用原图则不使用 'allowsOptimizeExporting'>
 */
