...
@implementation UIImage (MNBlurEffect)

- (UIImage *)lightEffect {
    UIColor *tintColor =[UIColor colorWithWhite:1.f alpha:.3f];
...
- (UIImage *)blurEffectWithRadius:(CGFloat)blurRadius tintColor:(UIColor*)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage*)maskImage {
