...
- (NSString *)hexString {
    return [UIColor hexStringWithColor:self];
}

NSString * HexStringWithColor (UIColor *color) {
    return [UIColor hexStringWithColor:color];
}
...
#pragma mark - 系统蓝色
inline UIColor * UIWindowTintColor (void) {
    return [UIColor colorWithRed:0.f/255.f green:122.f/255.f blue:254.f/255.f alpha:1.f];
}
