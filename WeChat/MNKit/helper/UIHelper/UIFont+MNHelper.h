...
typedef CGFloat MNFontWeight NS_TYPED_EXTENSIBLE_ENUM;
UIKIT_EXTERN const MNFontWeight MNFontWeightThin;
UIKIT_EXTERN const MNFontWeight MNFontWeightLight;
UIKIT_EXTERN const MNFontWeight MNFontWeightRegular;
UIKIT_EXTERN const MNFontWeight MNFontWeightMedium;
UIKIT_EXTERN const MNFontWeight MNFontWeightBold;
