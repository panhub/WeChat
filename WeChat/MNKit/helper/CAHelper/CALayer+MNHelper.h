...
/**
 ...
 @return layer实例
 */
+ (__kindof CALayer *)layerWithFrame:(CGRect)frame image:(UIImage *_Nullable)image;
...
UIKIT_EXTERN void CALayerSetMaskRadius (CALayer *layer, CGFloat radius);
...
UIKIT_EXTERN void CALayerSetBorderColor (CALayer *layer, CGFloat width, UIColor *color);
