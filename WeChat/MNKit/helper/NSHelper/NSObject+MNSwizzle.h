...
FOUNDATION_EXPORT BOOL MNSwizzleInstanceMethod(Class cls, SEL systemSelector, SEL swizzledSelector);
...
FOUNDATION_EXPORT BOOL MNSwizzleClassMethod(Class cls, SEL systemSelector, SEL swizzledSelector);
