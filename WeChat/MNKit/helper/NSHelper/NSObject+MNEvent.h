...
typedef void(^_Nullable MNEventHandler)(id sender);
...
/**
 ...
 @param eventHandler 事件回调
 */
- (void)handNotification:(NSNotificationName)notificationName object:(id _Nullable)obj eventHandler:(MNEventHandler)eventHandler;
...
/**
 ...
 @param eventHandler 点击事件回调
 */
- (void)handTapConfiguration:(void(^_Nullable)(UITapGestureRecognizer *recognizer))configuration eventHandler:(MNEventHandler)eventHandler;
 ...
 */
- (void)handPanConfiguration:(void(^_Nullable)(UIPanGestureRecognizer *recognizer))configuration eventHandler:(MNEventHandler)eventHandler;
 ...
 */
- (void)handLongPressConfiguration:(void(^_Nullable)(UILongPressGestureRecognizer *recognizer))configuration eventHandler:(MNEventHandler)eventHandler;
 ...
 */
- (void)handPinchConfiguration:(void(^_Nullable)(UIPinchGestureRecognizer *recognizer))configuration eventHandler:(MNEventHandler)eventHandler;
