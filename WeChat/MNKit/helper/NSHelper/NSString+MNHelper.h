...
/**
 转换为位置信息
 */
@property (nonatomic, readonly) CLLocationCoordinate2D coordinate2DValue;
/**
 将位置信息转换为字符串
 @return 位置信息字符串
 */
FOUNDATION_EXPORT NSString * NSStringFromCoordinate2D(CLLocationCoordinate2D);
#endif
/**
 获取基本数据类型字符串
 @return 字符串
 */
FOUNDATION_EXPORT NSString *NSStringFromNumber (NSNumber *);
