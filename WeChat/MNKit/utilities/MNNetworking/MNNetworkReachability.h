...
FOUNDATION_EXPORT NSString * const MNNetworkReachabilityStatusDidChangeNotification;
FOUNDATION_EXPORT NSString * const MNNetworkReachabilityNotificationStatusKey;
