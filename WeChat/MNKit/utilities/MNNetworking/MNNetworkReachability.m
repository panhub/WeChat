...
NSString * const MNNetworkReachabilityStatusDidChangeNotification = @"com.mn.network.reachability.change";
NSString * const MNNetworkReachabilityNotificationStatusKey = @"MNNetworkReachabilityNotificationStatusKey";
...
static void MNPostReachabilityStatusChange(SCNetworkReachabilityFlags flags, MNNetworkReachabilityStatusChangeBlock callback) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:MNNetworkReachabilityStatusDidChangeNotification
                                                            object:nil
                                                          userInfo:@{MNNetworkReachabilityNotificationStatusKey:@(status)}];
    });
}
...
- (void)setReachabilityStatusChangeHandler:(void (^)(MNNetworkReachabilityStatus status))handler {
