...
typedef void(^_Nullable MNSocialShareHandler)(id _Nullable result, NSError*_Nullable error);

@interface MNSocialShare : NSObject
/**
 分享网页到指定平台
 @param url 网址
 @param title 标题
...
/**
 ...
 @param title 标题
 @param desc 小标题
 @param thumbnailImage 封面图 <UIImage, NSData, NSString>
 @param webpageUrl 网址
 @param userName 用户名
 @param path 路径
 @param platform 平台
