...
- (void)layoutSubviews {
    ...
    // 文字高度
    CGSize noteSize = [NSString getStringSize:user.notename font:WXCardMsgNotenameTextFont];
    CGSize nickSize = [NSString getStringSize:user.nickname font:WXCardMsgNicknameTextFont];
    // 文字间隔
