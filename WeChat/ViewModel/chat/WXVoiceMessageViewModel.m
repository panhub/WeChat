...
- (void)layoutSubviews {
    ...
    if (model) {
        NSString *duration = model.content;
        ...
        if (self.message.isMine) {
            ...
            self.voiceViewModel.frame = CGRectMake(self.imageViewModel.frame.size.width - WXVoiceMsgIconWH - WXVoiceMsgIconLeftOrRightMargin, MEAN(self.imageViewModel.frame.size.height - WXVoiceMsgIconWH), WXVoiceMsgIconWH, WXVoiceMsgIconWH);
            self.textLabelModel.frame = CGRectMake(CGRectGetMinX(self.voiceViewModel.frame) - WXVoiceMsgIconTextMargin - size.width, MEAN(self.imageViewModel.frame.size.height - size.height), size.width, size.height);
        } else {
            ...
            self.voiceViewModel.frame = CGRectMake(WXVoiceMsgIconLeftOrRightMargin, MEAN(self.imageViewModel.frame.size.height - WXVoiceMsgIconWH), WXVoiceMsgIconWH, WXVoiceMsgIconWH);
            self.textLabelModel.frame = CGRectMake(CGRectGetMaxX(self.voiceViewModel.frame) + WXVoiceMsgIconTextMargin, MEAN(self.imageViewModel.frame.size.height - size.height), size.width, size.height);
        }
