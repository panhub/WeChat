...
#define WXMusicPlayerLyricTextColor  (WXPreference.preference.playStyle == WXPlayStyleDark ? MN_R_G_B(248.f, 248.f, 255.f) : [UIColor.darkTextColor colorWithAlphaComponent:.8f])
...
- (void)updateContent {
    ...
    CGFloat maxWidth = MN_SCREEN_WIDTH - WXMusicLyricHorMargin*2.f;
    ...
    if (contentSize.height >= font.pointSize*2.f) {
        CGSize size = [NSString stringSize:self.lyric.content font:font];
