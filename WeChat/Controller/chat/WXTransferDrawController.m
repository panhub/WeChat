...
- (void)createView {
    ...
    UIImageView *waitView = [UIImageView imageViewWithFrame:CGRectMake(MEAN(self.contentView.width_mn - 60.f), TOP_BAR_HEIGHT + 50.f, 60.f, 60.f) image:UIImageNamed(@"wx_transfer_waiting")];
    [self.contentView addSubview:waitView];
    
    UILabel *waitLabel = [UILabel labelWithFrame:CGRectMake(0.f, waitView.bottom_mn + 40.f, self.contentView.width_mn, 16.f) text:@"待确认收款" textAlignment:NSTextAlignmentCenter textColor:UIColor.darkTextColor font:UIFontRegular(16.f)];
    ...
    NSString *time = [NSDate dateStringWithTimestamp:self.redpacket.create_time format:@"yyyy-MM-dd HH:mm:ss"];
    UILabel *timeLabel = [UILabel labelWithFrame:CGRectMake(0.f, self.contentView.height_mn - 63.f, self.contentView.width_mn, 12.f) text:[@"转账时间: " stringByAppendingString:time] textAlignment:NSTextAlignmentCenter textColor:UIColorWithAlpha([UIColor darkTextColor], .6f) font:UIFontRegular(12.f)];
    ...
    UILabel *hintLabel = [UILabel labelWithFrame:CGRectMake(0.f, timeLabel.top_mn - 100.f, self.contentView.width_mn, 14.f) text:string textAlignment:NSTextAlignmentCenter textColor:nil font:nil];
