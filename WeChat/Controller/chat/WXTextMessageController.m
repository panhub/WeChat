...
- (void)createView {
    ...
    CGFloat y = MN_STATUS_BAR_HEIGHT + 20.f;
    UILabel *textLabel = [UILabel labelWithFrame:CGRectMake(25.f, y, self.contentView.width_mn - 50.f, self.contentView.height_mn - y*2.f) text:self.attributedText alignment:NSTextAlignmentCenter textColor:UIColorWithAlpha([UIColor darkTextColor], .9f) font:[UIFont systemFontOfSize:20.f]];
