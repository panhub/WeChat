...
- (void)createView {
    ...
    self.navigationBar.backgroundColor = R_G_B(243.f, 85.f, 67.f);
    ...
    if (self.redpacket.isMine) {
        ...
        UILabel *textLabel = [UILabel labelWithFrame:CGRectMake(0.f, emojiButton.bottom_mn + 15.f, self.tableView.width_mn, 14.f) text:@"回复一个表情到聊天" textAlignment:NSTextAlignmentCenter textColor:R_G_B(217.f, 175.f, 104.f) font:@(14.f)];
...
- (void)loadData {
    ...
    model.desc = [NSDate dateStringWithTimestamp:self.redpacket.draw_time format:@"MM-dd HH:mm"];
...
- (UIView *)navigationBarShouldCreateRightBarItem {
    UIButton *rightItem = [UIButton buttonWithFrame:CGRectMake(0.f, 0.f, 75.f, kNavItemSize)
                                             image:nil
                                             title:@"红包记录"
                                        titleColor:R_G_B(254.f, 225.f, 177.f)
                                              titleFont:@(17.f)];
