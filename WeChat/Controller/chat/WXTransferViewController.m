...
- (void)createView {
    ...
    UILabel *nameLabel = [UILabel labelWithFrame:CGRectMake(0.f, headView.bottom_mn + 15.f, self.contentView.width_mn, 20.f)
                                            text:[NSString stringWithFormat:@"%@ (**%@)", self.user.name, [NSString chineseWithLength:1]]
    ...
    [transferButton setBackgroundImage:[UIImage imageWithColor:MN_R_G_B(156.f, 229.f, 191.f)] forState:UIControlStateDisabled];
