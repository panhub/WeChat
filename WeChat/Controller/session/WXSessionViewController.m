...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    WXSessionCell *cell = [tableView dequeueReusableCellWithIdentifier:@"com.wx.session.cell"];
    if (!cell) {
        cell = [[WXSessionCell alloc] initWithReuseIdentifier:@"com.wx.session.cell" size:CGSizeMake(tableView.width_mn, tableView.rowHeight)];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(WXSessionCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
...
- (UIImage *)tabBarItemImage {
    return [UIImage imageNamed:@"tabbar_home"];
}

- (UIImage *)tabBarItemSelectedImage {
    return [UIImage imageNamed:@"tabbar_homeHL"];
}
