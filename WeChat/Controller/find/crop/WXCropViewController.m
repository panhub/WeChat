...
- (void)createView {
    ...
    UILabel *selectLabel = [UILabel labelWithFrame:CGRectMake(0.f, selectImageView.bottom_mn + 10.f, self.contentView.width_mn, 16.f) text:@"点击选择图片" textAlignment:NSTextAlignmentCenter textColor:UIColorWithAlpha(UIColor.darkTextColor, .88f) font:UIFontRegular(16.f)];
    ...
    selectButton.bottom_mn = self.contentView.height_mn - MAX(UITabSafeHeight(), 25.f) - 30.f;
...
- (void)selectButtonClicked {
    ...
    imagePicker.configuration.exportPixel = 0.f;
...
- (void)reloadList {
    MNCollectionVerticalLayout *layout = self.collectionLayout;
