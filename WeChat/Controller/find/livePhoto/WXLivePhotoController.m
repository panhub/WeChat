...
- (void)createView {
    ...
    UIImage *image = [UIImage imageWithContentsOfFile:self.livePhoto.imagePath];
    CGSize displaySize = self.contentView.size_mn;
    displaySize.height -= (UITabSafeHeight() + 30.f);
    ...
    livePhotoView.centerY_mn = (self.contentView.height_mn - UITabSafeHeight())/2.f;
