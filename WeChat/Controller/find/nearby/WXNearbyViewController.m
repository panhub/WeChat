...
- (void)createView {
    ...
    if (MN_TAB_SAFE_HEIGHT > 0.f) self.tableView.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0.f, 0.f, self.tableView.width_mn, MN_TAB_SAFE_HEIGHT)];
}
...
- (UIView *)loadFooter {
    return [[NSClassFromString(@"MNRefreshFooter") alloc] init];
}
