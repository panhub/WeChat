...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    WXMusicPlayController *vc = [[WXMusicPlayController alloc] initWithSongs:self.dataArray playIndex:indexPath.item];
...
- (UICollectionViewLayout *)collectionViewLayout {
    ...
    layout.sectionInset = UIEdgeInsetsMake(0.f, 10.f, MAX(MN_TAB_SAFE_HEIGHT, 10.f), 10.f);
    return layout;
}
