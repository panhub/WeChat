...
- (void)createView {
    ...
    UILabel *backgroundLabel = [UILabel labelWithFrame:self.tableView.bounds text:nil textAlignment:NSTextAlignmentCenter textColor:UIColor.whiteColor font:UIFontRegular(16.f)];
