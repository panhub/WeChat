...
- (void)createView {
    ...
    UILabel *lyricLabel = [UILabel labelWithFrame:CGRectMake(20.f, 0.f, scrollView.width_mn - 40.f, 25.f) text:nil textAlignment:NSTextAlignmentCenter textColor:nil font:UIFontRegular(16.f)];
    ...
    // 优化指针
    // 将指针中心点移动中间位置
    CGFloat x = UIScreenScale() <= 2.f ? 28.f/175.f*needleView.width_mn : 48.f/322.f*needleView.width_mn;
    CGFloat y = UIScreenScale() <= 2.f ? 28.f/252.f*needleView.height_mn : 48.f/495.f*needleView.height_mn;
...
#pragma mark - 更新背景
- (void)updateSubviews {
    self.lyricLabel.textColor = WXPreference.preference.playStyle == WXMusicPlayStyleDark ? WXMusicPlayerWhiteColor : WXMusicPlayerDarkColor;
}
