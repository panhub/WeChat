...
- (void)viewDidLoad {
    ...
    /// 检索结果展示
    WXAppletResultController *resultController = [[WXAppletResultController alloc] initWithFrame:CGRectMake(0.f, self.navigationBar.height_mn + self.tableView.tableHeaderView.height_mn, self.view.width_mn, self.view.height_mn - UIStatusBarHeight() - self.searchBar.height_mn)];
