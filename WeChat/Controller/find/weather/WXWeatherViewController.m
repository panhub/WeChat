...
- (UIView *)navigationBarShouldCreateLeftBarItem {
    ...
    UILabel *cityLabel = [UILabel labelWithFrame:CGRectMake(backView.right_mn - 5.f, MEAN(leftItemView.height_mn - 16.f), width, 16.f) text:string textAlignment:NSTextAlignmentLeft textColor:[UIColor whiteColor] font:[UIFont systemFontOfSize:16.f]];
