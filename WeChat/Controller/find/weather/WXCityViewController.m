...
@interface WXCityViewController () <MNLinkViewControllerDelegate, MNLinkViewControllerDataSource>
@property (nonatomic, strong) MNLinkViewController *listViewController;
@end
...
- (void)createView {
    ...
    MNLinkViewController *listViewController = [[MNLinkViewController alloc] initWithFrame:self.contentView.bounds];
...
- (void)linkViewControllerInitializedConfiguration:(MNLinkTableConfiguration *)configuration {
    ...
    configuration.selectedBackgroundColor = UIColorWithSingleRGB(51.f);
