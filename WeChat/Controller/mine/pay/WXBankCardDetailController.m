...
- (void)createView {
    ...
    UIView *iconView = [[UIView alloc] initWithFrame:CGRectMake(MEAN(self.tableView.width_mn - 37.f), TOP_BAR_HEIGHT + 5.f, 37.f, 37.f)];
    ...
    UILabel *nameLabel = [UILabel labelWithFrame:CGRectMake(0.f, iconView.bottom_mn + 15.f, self.tableView.width_mn, 16.f) text:self.card.name textAlignment:NSTextAlignmentCenter textColor:[UIColor whiteColor] font:UIFontMedium(16.f)];
    ...
    [titles enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        UILabel *moneyLabel = [UILabel labelWithFrame:CGRectMake(0.f, titleLabel.top_mn, 0.f, titleLabel.height_mn) text:moneys[idx] textAlignment:NSTextAlignmentRight textColor:UIColorWithAlpha([UIColor darkGrayColor], .75f) font:UIFontMedium(15.f)];
    ...
    UILabel *hintLabel = [UILabel labelWithFrame:CGRectMake(0.f, self.tableView.height_mn - 33.f, self.tableView.width_mn, 13.f) text:@"交易限额咨询: 95017" textAlignment:NSTextAlignmentCenter textColor:UIColorWithAlpha([UIColor whiteColor], .45f) font:[UIFont systemFontOfSize:13.f]];
...
- (void)navigationBarRightBarItemTouchUpInside:(UIView *)rightBarItem {
    MNActionSheet *actionSheet = [MNActionSheet actionSheetWithTitle:nil cancelButtonTitle:@"取消" handler:^(MNActionSheet *ac, NSInteger buttonIndex) {
        ...
        [MNChatHelper deleteBankCard:self.card completion:^(BOOL succeed) {
