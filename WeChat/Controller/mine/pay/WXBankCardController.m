...
- (void)createView {
    ...
    UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(0.f, 0.f, self.tableView.width_mn, MN_TOP_BAR_HEIGHT + 10.f)];
...
- (void)loadData {
    self.dataArray = [[[WechatHelper helper] cards] copy];
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    [self setNavigationBarBlurEffectHidden:(scrollView.contentOffset.y <= (self.tableView.tableHeaderView.height_mn - MN_TOP_BAR_HEIGHT))];
}
