...
- (void)createView {
    ...
    UIImageView *imageView = [UIImageView imageViewWithFrame:CGRectMake(MEAN(self.tableView.width_mn - 75.f), TOP_BAR_HEIGHT + 40.f, 75.f, 75.f) image:[UIImage imageNamed:@"wx_pay_money_icon"]];
    [self.tableView addSubview:imageView];
    
    UILabel *titleLabel = [UILabel labelWithFrame:CGRectMake(0.f, imageView.bottom_mn + 30.f, self.tableView.width_mn, 16.f) text:@"我的零钱" textAlignment:NSTextAlignmentCenter textColor:UIColorWithAlpha([UIColor darkTextColor], .85f) font:UIFontRegular(16.5f)];
    ...
    UILabel *earnLabel = [UILabel labelWithFrame:CGRectMake(titleLabel.left_mn, moneyLabel.bottom_mn + 40.f, titleLabel.width_mn, 16.f) text:@"转入零钱通 给自己加加薪 >" textAlignment:NSTextAlignmentCenter textColor:R_G_B(249.f, 156.f, 56.f) font:UIFontRegular(16.f)];
    ...
    hintLabel.bottom_mn = self.tableView.height_mn - 10.f;
