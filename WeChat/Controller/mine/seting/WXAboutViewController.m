...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        ...
        [MNUpdater checkProductVersionFromItunes:AppleID timeoutInterval:10.f completion:^(BOOL update, NSString * _Nullable version, NSDictionary * _Nullable result, NSError * _Nullable error) {
