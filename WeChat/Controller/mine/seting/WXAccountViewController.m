...
- (void)loadData {
    ...
    NSMutableArray <NSArray <NSString *>*>*descs = @[@[[[WXUser shareInfo] wechatId], [[WXUser shareInfo] number]]].mutableCopy;
    if (WXPreference.preference.loginType != WXLoginTypeApple) {
