...
- (void)createView {
    ...
    if (self.numberOfWords > 0) {
        ...
        UILabel *numberLabel = [UILabel labelWithFrame:CGRectMake(textView.left_mn, textView.bottom_mn + margin, textView.width_mn, 15) text:NSStringFromNumber(@(self.numberOfWords - textView.text.length)) textAlignment:NSTextAlignmentRight textColor:UIColorWithAlpha([UIColor darkGrayColor], .6f) font:[UIFont systemFontOfSize:15.f]];
