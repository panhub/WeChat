...
@interface WXLocalEvaluationController () <UIAlertViewDelegate>

@end

@implementation WXLocalEvaluationController
- (instancetype)init {
    if (self = [super init]) {
        self.title = @"验证密码";
    }
...
- (void)evaluateTouchID {
    [MNLocalEvaluation evaluateReason:@"验证指纹以继续" password:^{
