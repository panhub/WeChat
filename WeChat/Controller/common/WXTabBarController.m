...
- (void)viewDidLoad {
    ...
    self.tabView.shadowView.backgroundColor = [UIColor.darkGrayColor colorWithAlphaComponent:.13f];
...
- (NSInteger)updateMomentBadgeValue {
    ...
    if (!vc) return 0;
    NSInteger count = MIN([[MNDatabase database] selectCountFromTable:WXMomentNotifyTableName where:nil], 99);
