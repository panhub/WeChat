...
- (void)createView {
    ...
    WXVideoPlayTopBar *topBar = [[WXVideoPlayTopBar alloc] initWithFrame:CGRectMake(0.f, 0.f, self.contentView.width_mn, TOP_BAR_HEIGHT)];
    topBar.delegate = self;
    [self.contentView addSubview:topBar];
    self.topBar = topBar;
    
    WXVideoPlayTabBar *tabBar = [[WXVideoPlayTabBar alloc] initWithFrame:CGRectMake(0.f, 0.f, self.contentView.width_mn, UITabSafeHeight() + 70.f)];
