...
#import "TEScaleView.h"

@interface TEScaleView ()
/// 所需弧度
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _scaleInterval = 10.f;
        _scaleLinePer = 6;
        _scaleLineMinWidth = 2.f;
        _scaleLineMaxWidth = 6.f;
...
- (CGPoint)calculateLabelPositonWithAngle:(CGFloat)angel {
    CGFloat x = (_scaleRadius - _scaleLineMaxWidth - 4.f)*cosf(angel);
    CGFloat y = (_scaleRadius - _scaleLineMaxWidth - 4.f)*sinf(angel);
